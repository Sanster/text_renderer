...
def parse_args():
    ...
    parser.add_argument('--num_img', type=int, default=1000, help="Number of images to generate")
    ...
    parser.add_argument('--corpus_mode', type=str, default='npychn', choices=['random', 'chn', 'eng', 'list','npychn'],
                        help='Different corpus type have different load/get_sample method'
                             ...
                             'npychn:pick continuous chars form npy file')
